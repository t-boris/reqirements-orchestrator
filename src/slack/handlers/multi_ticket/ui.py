"""UI components and edit handlers for multi-ticket workflow.

Handles:
- Edit item modal building and submission
...
from src.slack.handlers.multi_ticket.linking import extract_item_id, extract_ui_version
